...
<html>
  ...
  <link rel="stylesheet" href="css/hashtag4.css"/>
		<title>
			Hashtag Search
		</title>
...
?>
	  ...
	  <form id = "searchs" method = "post">
        ...
        <div class = "moreInfo">
            ...
            <div class = "outClose" id = "outCloses"><button class = "close" onclick="clickHandlers(event)">x</button></div>
            <div class="pages-list-item">
                <?php $x = 0; ?>
            <?php for($x = 0; $x < 14; $x++){?>
                <?php if ('IMAGE' ==  $hashtagTopMedia['data'][$x]['media_type']) : ?>
                    <div class = "tps<?php echo $x?>">
					<img style="margin-bottom: 10px; margin-left: 20px; height:201px; grid-row:1; width: 322px;" src="<?php echo  $hashtagTopMedia['data'][$x]['media_url']; ?>" />
