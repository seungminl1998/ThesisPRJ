...
<html>
  ...
  <link rel="stylesheet" href="css/hashtag2.css"/>
		<title>
			Hashtag Search
		</title>
    ...
    ?>
    <div class = 'tagsInfo' id = '<?php ".$data."?>'>
      <form action = 'hashtag2.php' class = 'exTitle' method = 'get'>
        ...
        <button class = 'plus' name = 'agregar' id = '<?php ".$data."?>in'>+</button>
        <div class = 'cerrar'>x</div>
        </form>
      <div class = 'tageo' name = '<?php ".$data."?>s'>
        <?php       
         if ($result1->num_rows > 0) {
          ...
          echo "<p class = 'oneMore'>0 Results</p>";

        } 	?>
      </div>
        <button class = 'exDelete'>Delete</button>
    </div> 
        </div>
      </div>
